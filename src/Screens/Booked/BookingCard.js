...
const BookingCard = memo(
  ({
    ...
    const getStatusConfig = () => {
      ...
      switch(status) {
        case 'Confirmed':
          return { color: theme.color.successPrimary, label: 'Confirmed', icon: 'check-circle' };
        case 'Ongoing':
          return { color: theme.color.warning, label: 'In Progress', icon: 'clock' };
        case 'Completed':
          return { color: theme.color.successPrimary, label: 'Completed', icon: 'check-circle' };
        case 'Canceled':
          return { color: theme.color.error, label: 'Canceled', icon: 'x-circle' };
        default:
